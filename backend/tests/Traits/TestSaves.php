...
trait TestSaves
{
    ...
    protected function assertStore(array $sendData, array $testDatabase, array $testJasonData = null): TestResponse
    {
        ...
        $this->assertJsonResponseContent($response, $testDatabase, $testJasonData);
        return $response;
    }
